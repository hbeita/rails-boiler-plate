...
class Membership::ChurchServicesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create membership_church_service" do
    assert_difference('Membership::ChurchService.count') do
      post membership_church_services_url, params: { membership_church_service: { date: @membership_church_service.date } }
    end
  ...
  test "should update membership_church_service" do
    patch membership_church_service_url(@membership_church_service), params: { membership_church_service: { date: @membership_church_service.date } }
